...
with h5py.File(
    "/Users/emre/Documents/GitHub/crypto_scraping_project/hdf5_data.h5", "a"
) as hdf:
    ...
    hdf["crypto_prices"]["yahoo_prices"].resize(
        (hdf["crypto_prices"]["yahoo_prices"].shape[0] + mask_lsit.shape[0]), axis=0
    )
